...
<div id="myCarousel" class="carousel slide" data-ride="carousel" data-interval="2000">
    ...
    <a class="carousel-control right" href="#myCarousel" 
        data-slide="next">&rsaquo;
					...
					<div id="right" class="bgcolor">
                                        <img src="images/big_data2.png">
                                        </div>
				</div>
			</div>
			<div class="nav"> </div>
        ...
        <div class="col-md-2"><a href="#" target="_self">发展动态</a></div>
			...
			<div class="nav"> </div>
				...
				<div class="bar border">
                                <div class="bar-title">合理分配医疗资源</div>
                                <div class="bar-title-pic"> <img src="images/yiliao1.jpg"></div>
                                </div>
				<div class="nav"> </div>
				<div class="bar border">
                                <div class="bar-title">提供远程医疗服务</div>
                                <div class="bar-title-pic"> <img src="images/yiliao2.jpg"></div>
                                </div>
				<div class="nav"> </div>
				<div class="bar border">
                                <div class="bar-title">提升医院管理水平</div>
                                <div class="bar-title-pic"><img src="images/yiliao3.jpg"></div>
                                </div>
			</div>
			<div id="content">
				<div class="left_box border">
                                 <img src="images/lanmu1.jpg">   
                                </div>
				<div class="right_box border">
                                 <img src="images/lanmu2.jpg">
                                </div>
				<div class="nav"> </div>
				<div class="left_box">
